...
exports.addSupply = (req, res) => {
    ...
    db.query(query, [e.vendor_id, e.project, e.name, e.details, e.quantity, e.rate,e.sgst,e.cgst,e.uom,e.total_amount,e.date], (err, results) => {
        if (!err) {
...
exports.updateSupply = (req, res) => {
    ...
    db.query(query, [e.name, e.details, e.quantity, e.rate, e.sgst, e.cgst,e.uom,e.total_amount,e.date, req.params.id], (err, results) => {
        if (!err) {
